...
(() => {
  ...
  // src/data.ts
  var AssetTypeSchema = z.literal("audio").or(z.literal("image")).or(z.literal("tiles"));
  var AssetReferenceSchema = z.string();
  var GalleryModelSchema = z.array(AssetReferenceSchema);
  var LatLngSchema = z.object({
    lat: z.number(),
    lng: z.number()
  });
  var PoiModelSchema = z.object({
    id: z.string(),
    title: z.string(),
    desc: z.string(),
    lat: z.number(),
  ...
  var ControlPointModelSchema = z.object({
  ...
  var link = clone.querySelector("a.edit-tour-link");
  var linkText = window.location.origin + "/?shufti-load-project=" + encodeURIComponent(window.location.href);
  link.href = linkText;
